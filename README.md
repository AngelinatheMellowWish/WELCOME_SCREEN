...
- 用户手册（中文）：[`docs/MANUAL[v1.2.0].md`](docs/MANUAL[v1.2.0].md)
- User Manual (English): [`docs/MANUAL.en[v1.2.0].md`](docs/MANUAL.en[v1.2.0].md)
- 变更日志：[`docs/CHANGELOG[v1.2.0].md`](docs/CHANGELOG[v1.2.0].md)
